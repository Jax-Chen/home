        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="<%=base %>/hadmin/#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">${sessionScope.user.uname}</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">${sessionScope.user.uname}
                        </div>
                    </li>
                    ...
                    <li>
                        <a class="J_menuItem" href="<%=base %>/front/orderList.do">
                            <i class="fa order"></i>
                    ...
                    <li>
                        <a class="J_menuItem" href="<%=base %>/front/user/detailView.do">
...
<!--                     </li> -->
                    ...
                    <li>
                        <a class="J_menuItem" href="<%=base %>/front/logout.do"><i class="fa fa-logout"></i> <span class="nav-label">退出</span></a>
                    </li>
...
<!--                                 <input type="text" placeholder="请输入您需要查找的内容 …" class="form-control" name="top-search" id="top-search"> -->
 									<label style="margin-top:16px;font-size:18px;margin-left:10px;">智慧社区养老系统前台</label>
                            </div>
                        </form>
                    </div>
            ...
            <div class="row J_mainContent" id="content-main">
	                <iframe id="J_iframe" width="100%" height="100%" src="<%=base %>/front/orderList.do" frameborder="0" data-id="<%=base %>/WEB-INF/jsp/front/orderList.jsp?v=1.0" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
