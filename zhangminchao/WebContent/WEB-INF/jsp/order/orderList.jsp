            ...
            <div class="col-sm-4">
                <div class="ibox">
                    <div class="ibox-content">
                    	...
                    	<form id="searchForm" action="<%=base %>/bops/orderList.do" method="post">
	                                ...
	                                <div class="agile-detail" style="margin-top:10px;">
	                                	...
	                                	<c:choose>
										   <c:when test="${order.status==0}">
										  	 	...
										  	 	<a href="javascript:;" class="pull-right btn btn-xs btn-info begin" style="margin-left: 10px;">开始</a>
										   </c:when>
										   <c:when test="${order.status==1}">
										  	 	<a href="javascript:;" class="pull-right btn btn-xs btn-warning cancel" style="margin-left: 10px;">取消</a>
										   </c:when>
...
<script src="<%=base %>/src/scripts/bops/orderList.js"></script>
</body>
</html>