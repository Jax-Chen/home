                            ...
                            <div class="col-sm-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
										<div>
											<button style="float:right;margin-right:60px;margin-top:-9px;" type="button" class="btn btn-shadow btn-primary home-add">新增社区</button>
										</div>
										社区列表
                                    </div>
                                    
                                    <form id="searchForm" action="<%=base %>/bops/homeList.do" method="post">
...
<!--                                                     style="background-color:#ffffff;" -->
														<c:forEach items="${page.data}" var="home" varStatus="status">
                                                            ...
                                                            <tr class="my-tr" <c:choose><c:when test="${status.index%2==0}">style="background-color:#ffffff;"</c:when><c:otherwise>style="background-color:#f5f5f5;"</c:otherwise></c:choose>   >
                                            					...
                                            					<td class="">
                                            						<input type="hidden" name="homeId" class="homeId" value=${home.id }>
...
<!--                         <link href="$!{imageServer}/newframe/css/plugins/iCheck/custom.css" rel="stylesheet"> -->
                    	...
                    	<script src="<%=base %>/src/scripts/bops/homeList.js"></script>
</body>
</html>