...
function dTree(objName, isP) {
	this.config = {
		...
		inOrder					: false,
		isPCheck : isP==null?true:isP
	}
	this.icon = {
		root				: imageServer + '/scripts/bops/dtree/img/base.gif',
		folder			: imageServer + '/scripts/bops/dtree/img/folder.gif',
		folderOpen	: imageServer + '/scripts/bops/dtree/img/folderopen.gif',
		node				: imageServer + '/scripts/bops/dtree/img/page.gif',
		empty				: imageServer + '/scripts/bops/dtree/img/empty.gif',
		line				: imageServer + '/scripts/bops/dtree/img/line.gif',
		join				: imageServer + '/scripts/bops/dtree/img/join.gif',
		joinBottom	: imageServer + '/scripts/bops/dtree/img/joinbottom.gif',
		plus				: imageServer + '/scripts/bops/dtree/img/plus.gif',
		plusBottom	: imageServer + '/scripts/bops/dtree/img/plusbottom.gif',
		minus				: imageServer + '/scripts/bops/dtree/img/minus.gif',
		minusBottom	: imageServer + '/scripts/bops/dtree/img/minusbottom.gif',
		nlPlus			: imageServer + '/scripts/bops/dtree/img/nolines_plus.gif',
		nlMinus			: imageServer + '/scripts/bops/dtree/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
