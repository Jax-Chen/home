 ...
 * depend on JQuery
 */
var SimpleTable = function(formId,pageNumber,pageSize,sortColumns,requestUrl,pageNumberKey,pageSizeKey,sortColumnsKey,requestUrlKey) {
	this.form = formId;
	...
	this.requestUrlKey = requestUrlKey || 'requestUrl';
	//handle sort
	_this = this;
...
SimpleTable.prototype = {
	doJump : function(pageNumber,pageSize,sortColumns,requestUrl) {
		...
		pair(this.requestUrlKey,this.requestUrl);
